...
export const metadata = {
  title: 'Bundle Deals',
  description: 'Get multiple 3D prints at a discounted price with our bundle deals.',
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-10">
          ...
          <p className="text-brand-muted mt-3 max-w-xl">
            Get more for less. Our bundles group complementary prints together at a discounted
            price — perfect if you know what you need.
          </p>
        </div>
        ...
        {allBundles.length === 0 ? (
          <div className="text-center py-24">
            ...
            <h3 className="text-lg font-semibold text-brand-text mb-2">No bundles yet</h3>
            <p className="text-brand-muted text-sm">Check back soon for bundle deals.</p>
          </div>
        ) : (
