...
export function MarkdownDescription({ content }: Props) {
  return (
    <div className="prose prose-sm max-w-none text-brand-muted leading-relaxed
      ...
      prose-pre:bg-brand-arctic prose-pre:rounded-sm prose-pre:border prose-pre:border-brand-border
      prose-img:rounded-sm prose-img:border prose-img:border-brand-border
