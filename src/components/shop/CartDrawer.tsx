...
export function CartDrawer() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          'fixed top-0 right-0 h-full w-full max-w-md z-50 bg-brand-surface border-l border-brand-border flex flex-col transition-transform duration-300 ease-in-out shadow-card-lg',
